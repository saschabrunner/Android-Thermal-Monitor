...
# Guava rules, taken from https://github.com/google/guava/wiki/UsingProGuardWithGuava
...
# Exclude own code for simplicity (for now)
-keep class com.gitlab.saschabrunner.thermalmonitor.**